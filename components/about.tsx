      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-lg text-muted-foreground mb-6 text-pretty">{t("about.subtitle")}</p>

            <p className="text-base text-muted-foreground mb-8 text-pretty">{t("about.description")}</p>
