            ...
            <div className="flex flex-col sm:flex-row gap-10 mb-8">
              ...
              <Link href="/contacto" className="group">
                <div className="relative bg-white px-8 py-4 shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  ...
                  <div className="absolute -top-1.5 -left-1.5 w-6 h-6 border-t-[6px] border-l-[6px] border-primary transition-all duration-300 group-hover:w-8 group-hover:h-8 group-hover:-top-2 group-hover:-left-2"></div>
                  {/* Top-right corner bracket */}
                  <div className="absolute -top-1.5 -right-1.5 w-6 h-6 border-t-[6px] border-r-[6px] border-primary transition-all duration-300 group-hover:w-8 group-hover:h-8 group-hover:-top-2 group-hover:-right-2"></div>
                  {/* Bottom-left corner bracket */}
                  <div className="absolute -bottom-1.5 -left-1.5 w-6 h-6 border-b-[6px] border-l-[6px] border-primary transition-all duration-300 group-hover:w-8 group-hover:h-8 group-hover:-bottom-2 group-hover:-left-2"></div>
                  {/* Bottom-right corner bracket */}
                  <div className="absolute -bottom-1.5 -right-1.5 w-6 h-6 border-b-[6px] border-r-[6px] border-primary transition-all duration-300 group-hover:w-8 group-hover:h-8 group-hover:-bottom-2 group-hover:-right-2"></div>

                  <span className="text-xl font-semibold text-primary block tracking-wide">{t("hero.requestEstimate")}</span>
                  <span className="text-xl font-semibold text-primary block tracking-wide">{t("hero.estimation")}</span>
                </div>
              </Link>
              ...
              <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="group">
                <div className="relative bg-white px-8 py-4 shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  ...
                  <span className="text-xl font-semibold text-primary block tracking-wide">{t("hero.schedule")}</span>
                  <span className="text-xl font-semibold text-primary block tracking-wide">{t("hero.now")}</span>
                </div>
              </a>
            </div>
